...
class PDF extends FPDF
{
    ...
    function Footer()
    {
        ...
        $pdf->SetFont('Courier','',10);
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(60, 8,utf8_decode($filaCursos['curso']),1,0,'C'); $pdf->Cell(60,8,$filaCursos['duracion'],1,0,'C'); $pdf->Cell(50, 8,$filaCursos['recivido'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(60, 8,utf8_decode($filaCursos['curso1']),1,0,'C'); $pdf->Cell(60,8,$filaCursos['duracion1'],1,0,'C'); $pdf->Cell(50, 8,$filaCursos['recivido1'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(60, 8,utf8_decode($filaCursos['curso2']),1,0,'C'); $pdf->Cell(60,8,$filaCursos['duracion2'],1,0,'C'); $pdf->Cell(50, 8,$filaCursos['recivido2'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(60, 8,utf8_decode($filaCursos['curso3']),1,0,'C'); $pdf->Cell(60,8,$filaCursos['duracion3'],1,0,'C'); $pdf->Cell(50, 8,$filaCursos['recivido3'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Ln(20);
