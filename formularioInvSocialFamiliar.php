...
<!--         		    <div class="form-group">
                    ...
                    <div id="myForm">
                          <div id="cosponsors" style="padding:12px;">
                            ...
                            <select type="text" id="parentesco" placeholder="Parentesco" name="parentesco" title="Campo parentesco" required>
                                                <option selected value="">Seleccione un parentesco</option>
                                                <option value="Hijo(a)">Hijo(a)</option>
                                                <option value="Esposo(a)">Esposa(a)</option>
                                                <option value="Padres">Padres</option>
                            ...
                            <input  type="text" id="nombre" name="nombre"  placeholder="Nombre" title="Campo nombre" required/>
                            <input  type="text" id="edad"name="edad" placeholder="Edad" title="Campo edad" required/>
                            <input  type="text" id="ocupacion" name="ocupacion" placeholder="Ocupacion" title="Campo ocupacion" required/>
