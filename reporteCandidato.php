...
class PDF extends FPDF
{
    ...
    function Footer()
    {
        ...
        $pdf->Ln(10);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(90, 8,'1. Eventos sociales (familiares o amigos)',1,0,'C'); $pdf->Cell(80,8,$filaActi['sociales'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(90, 8,'2. Eventos comunitarios',1,0,'C'); $pdf->Cell(80,8,$filaActi['comunitarios'],1,0,'C');
        $pdf->Ln(15);
        ...
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(90, 8,'Teatro',1,0,'C'); $pdf->Cell(80,8,$filaActi['teatro'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(90, 8,'Festivales Culturales',1,0,'C'); $pdf->Cell(80,8,$filaActi['culturales'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(90, 8,'Zonas Arqueologicas',1,0,'C'); $pdf->Cell(80,8,$filaActi['arqueologicas'],1,0,'C');
        $pdf->Ln(15);
        ...
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(60, 8,$filaActi['deporte'],1,0,'C'); $pdf->Cell(60,8,$filaActi['lugar'],1,0,'C'); $pdf->Cell(50, 8,$filaActi['frecuencia'],1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(60, 8,$filaActi['deporteDos'],1,0,'C'); $pdf->Cell(60,8,$filaActi['lugarDos'],1,0,'C'); $pdf->Cell(50, 8,$filaActi['frecuenciaDos'],1,0,'C');
        $pdf->Ln(15);
        ...
        $pdf->Ln(8);
        $pdf->Cell(10,0,"",0,0,'L'); $pdf->Cell(50, 8,'Metro (   )',1,0,'C'); $pdf->Cell(35,8,utf8_decode('Transporte público(   )'),1,0,'C');  $pdf->Cell(45,8,'Taxi(   )',1,0,'C');  $pdf->Cell(40,8,utf8_decode('Otro(   )'),1,0,'C');
        $pdf->Ln(8);
        //Conteo de paginas
        $pdf->AliasNbPages();
         //Final de pdf
