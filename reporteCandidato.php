...
class PDF extends FPDF
{
    ...
    function Footer()
    {
        ...
        $pdf->Cell(100, 8, 'ELEMENTO', 1); $pdf->Cell(70, 8, 'Fecha: '.date('d/m/Y').'',1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(100, 8,$fila['nombre'],1,0,'C'); $pdf->Cell(70, 8, 'GERENCIA DE CAPITAL HUMANO',1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(100, 8,"",1,0,'C'); $pdf->Cell(70, 8, 'SERVICIO',1,0,'C');
        $pdf->Ln(9);
        $pdf->Cell(60,0,"",0,0,'L');$pdf->Image($fila['rutaImagen'],null,null,40,50);
        $pdf->Ln(5);
