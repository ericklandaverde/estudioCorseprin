...
class PDF extends FPDF
{
    ...
    function Footer()
    {
        ...
        $pdf->Cell(100, 8, 'ELEMENTO', 1); $pdf->Cell(60, 8, 'Fecha: '.date('d/m/Y').'',1,0,'C');
        $pdf->Ln(8);
        $pdf->Cell(100, 8,$fila['nombre'],1,0,'C'); $pdf->Cell(60, 8, 'GERENCIA DE CAPITAL HUMANO',1,'C');
        $pdf->Ln(8);
        $pdf->Cell(100, 8,"",1,0,'C'); $pdf->Cell(30, 8, 'SERVICIO',1,0,'C');
        $pdf->Ln(8);
